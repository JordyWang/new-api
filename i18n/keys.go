...
const (
	...
	MsgUserRegistrationInviteRequired      = "user.registration_invite_required"
	MsgUserRegistrationInviteNotConfigured = "user.registration_invite_not_configured"
	MsgUserRegistrationInviteInvalid       = "user.registration_invite_invalid"
	MsgUserRegistrationInviteExpired       = "user.registration_invite_expired"
	MsgUserRegistrationInviteExhausted     = "user.registration_invite_exhausted"
)
